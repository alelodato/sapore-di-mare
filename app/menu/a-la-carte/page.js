...
export const metadata = {
  title: 'À La Carte Menu — Sapore Di Mare',
};

const ALA_CARTE_SLUGS = [
  'raw-fish',
  'vegetarian-starters',
  'hot-starters',
  'pasta-risotto',
  ...
  return (
    <div className="pt-20">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-20 md:py-32">
        <p className="text-cream/40 text-sm font-light leading-relaxed mb-16 max-w-2xl">
          All our dishes are prepared fresh daily using the finest sustainable seafood and seasonal produce.
          Our pasta is made by hand each morning. Please inform your server of any dietary requirements.
        </p>
            ...
            <div key={section.id} id={section.slug}>
              ...
              <div className="space-y-6 border-t border-white/5">
                {section.menu_items
                  ...
                  .map((item) => (
                    <div key={item.id} className="group pt-6 border-b border-white/5 pb-6 hover:border-gold/10 transition-colors">
                      ...
                      {item.image_url && (
                        <div className="relative w-full h-40 mt-4 overflow-hidden">
        ...
        <div className="mt-16 flex flex-col md:flex-row justify-between gap-4">
          ...
          <Link href="/menu/dessert" className="btn-gold-filled">
            Dessert Menu <ArrowRight size={14} />
          </Link>
        </div>
      </div>
    </div>
